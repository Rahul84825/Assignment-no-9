              ...
              <div key={pass._id} className="pass-card">
                ...
                <div className="pass-details">
                  ...
                  <div style={{ marginTop: "12px", display: "flex", gap: "10px", flexWrap: "wrap" }}>
                    {pass.qrDataUrl && (
                      <div style={{ background: "white", padding: "8px", borderRadius: "4px", border: "1px solid #ddd" }}>
                        <img src={pass.qrDataUrl} alt="QR Code" style={{ width: "100px", height: "100px", display: "block" }} />
                      </div>
                    )}
                    {pass.pdfPath && (
                      <a
                        href={`${import.meta.env.VITE_API_BASE_URL?.replace("/api", "") || "http://localhost:8081"}${pass.pdfPath}`}
                        target="_blank"
